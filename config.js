...
const WEDDING_CONFIG = {
  ...
  littleStars: {
    names: ["Tappu", "Tuktuk", "Pihu", "Tasu", "Tasi", "Aadvit", "Radha", "Ishaan"],
    namesHi: ["टप्पू", "टुकटुक", "पिहू", "तासू", "तासी", "आद्वित", "राधा", "ईशान"]
  },
